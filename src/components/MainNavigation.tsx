...
const tabs: Tab[] = [
  { id: "today", labelKey: "nav.today", icon: "M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" },
...
function MainNavigation({ activeTab, onTabChange, onSettingsClick, isSettingsActive, accountMenu }: Props) {
  ...
  return (
    <nav className="bg-gray-800 text-white">
      <div className="flex items-center justify-between px-4">
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-t-lg transition-colors ${
                activeTab === tab.id && !isSettingsActive
        ...
        {/* Right side: Account menu and Settings */}
